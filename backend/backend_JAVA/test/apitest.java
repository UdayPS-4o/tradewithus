...
public class apitest {
    ...
    public void testAuthEndpoints() throws Exception {
        ...
        assertTrue(loginJsonResponse.has("message"));
        assertEquals("Login successful", loginJsonResponse.path("message").asText());
        authToken = loginJsonResponse.path("token").asText();
        assertFalse(authToken.isEmpty(), "Token should not be empty");
